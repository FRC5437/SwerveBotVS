...
public class RobotMap {
		...
		final public static int FRONT_LEFT_ABSOLUTE = 0;

		final public static int FRONT_RIGHT_ABSOLUTE = 1;
		
		final public static int REAR_LEFT_ABSOLUTE = 3;

		final public static int REAR_RIGHT_ABSOLUTE = 2;
